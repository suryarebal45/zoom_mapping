-- models/gold/go_engagement_summary.sql
...
participant_metrics AS (
    SELECT
        ...
        ROUND(SAFE_DIVIDE(SUM(DATEDIFF('minute', p.JOIN_TIME, p.LEAVE_TIME)), SUM(m.DURATION_MINUTES)),2) AS average_attention_score
